...
# ╔═╡ 6abb467c-aaec-11ec-36cf-f52266968171
begin
	using LightGraphs
	using GraphPlot
	using Colors
	using CairoMakie # Remplace with using Makie
	using StatsBase
	using Plots
	using JLD2
	using Compose
...
# ╔═╡ 65133a0d-8c39-4ea9-8641-bcac7c6f4e79
md"
# Graph project: Epidemic spreading

#### ENSEEIHT SN, notebook written by Bastien Vieuble
"

# ╔═╡ 6abb4672-aaec-11ec-13e9-2f864f7dff88
html"""
...
# ╔═╡ 2e4bb960-8879-4c30-9a0e-a0e868b2e801
karat7 = smallgraph(:karate)

# ╔═╡ 6d8c57b7-8038-42b7-a3d7-592f08bc57b0
draw(PNG("karat7.png", 100cm, 100cm), gplot(karat7)) 
...
git-tree-sha1 = "4f35ba91a3e3fad462c0bdcb1fdf4077373c36fe"
